...
public class Registration {
    ...
    public static void scene3(Balance[] Balance_List, Database database){
        JFrame frame2 = new JFrame("MoMo Bank - Debit Registration");
        ...
        next0.setBounds(30, 160, 60, 30);
        frame2.add(next0);

        JLabel head8 = new JLabel("First up, let’s get your details");
        head8.setBounds(30,200,500,30);
    ...
    public static void scene4(){
        JFrame frame2 = new JFrame("MoMo Bank - Credit Registration");
        frame2.setResizable(false);
        ...
        JLabel head5 = new JLabel("Please have your credit card number handy.");
        head5.setBounds(30,110,360,30);
        head5.setFont(new Font("Times New Roman", Font.PLAIN, 15));
        head5.setForeground(new java.awt.Color(0, 0, 0));
        frame2.add(head5);

        JLabel head6 = new JLabel("By continuing, you agree to our Electronic Banking Services Agreement");
        head6.setBounds(30,135,500,30);
        head6.setFont(new Font("Times New Roman", Font.PLAIN, 13));
        head6.setForeground(new java.awt.Color(0, 0, 0));
        frame2.add(head6);
