...
class GUI6 extends JFrame{
    ...
    public void exit_Page() throws IOException, UnsupportedAudioFileException, LineUnavailableException {
        ...
        String soundName = "C:\\Users\\david\\IdeaProjects\\desktopApp\\src\\CantinaBand60.wav";
        ...
        //Sound Option Brand
        ImageIcon brandSound1 = new ImageIcon("C:\\Users\\david\\IdeaProjects\\desktopApp\\src\\icon_sound_on.png");
        ImageIcon brandSound2 = new ImageIcon("C:\\Users\\david\\IdeaProjects\\desktopApp\\src\\icon_sound_off.png");
    ...
    public void Login_Page(Database Db1) throws Exception {
        ...
        AtomicReference<String> soundName = new AtomicReference<>("C:\\Users\\david\\IdeaProjects\\desktopApp\\src\\CantinaBand60.wav");
        ...
        //Music Option Brand
        ImageIcon brandMusic = new ImageIcon("C:\\Users\\david\\IdeaProjects\\desktopApp\\src\\icon_music.png");
        ...
        button_Music.addActionListener(e -> {
            if (ref.Music) {
                ref.Music = false;
                clip.get().stop();
                soundName.set("C:\\Users\\david\\IdeaProjects\\desktopApp\\src\\StarWars60.wav");
                try {
                ...
                ref.Music = true;
                clip.get().stop();
                soundName.set("C:\\Users\\david\\IdeaProjects\\desktopApp\\src\\CantinaBand60.wav");
                try {
                    audioInputStream.set(AudioSystem.getAudioInputStream(new File(String.valueOf(soundName)).getAbsoluteFile()));
                } catch (UnsupportedAudioFileException | IOException unsupportedAudioFileException) {
                    unsupportedAudioFileException.printStackTrace();
